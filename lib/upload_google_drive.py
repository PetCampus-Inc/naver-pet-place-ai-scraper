...
class UploadGoogleDrive:
    ...
    def upload_image(self, file_name: str, image_url: str) -> str:
...
if __name__ == "__main__":
    ...
    res = uploader.upload_image("test", "https://ldb-phinf.pstatic.net/20230307_187/1678176550329KOphr_JPEG/%C0%AF%C4%A1%BF%F8%B0%A1%B0%DD%C7%A5.jpg")
    print(res)